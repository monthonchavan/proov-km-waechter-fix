...
def test_wear_percent_is_not_floored():
    """wear_percent must use true division, not floor division.

    14,900 km of a 15,000 km window is ~99.3 %, not 0 %.
    """
    pct = wear_percent(14900, 15000)
    assert 99 <= pct <= 100, f"expected ~99.3 %, got {pct:.2f} %"
